...
```Groovy
implementation 'com.google.cloud:google-cloud-data-fusion:0.2.1'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-data-fusion" % "0.2.1"
```
...
[javadocs]: https://googleapis.dev/java/google-cloud-data-fusion/latest/index.html
